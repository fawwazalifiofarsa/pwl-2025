...
var FullCalendar = (function (exports) {
    ...
    Permission to use, copy, modify, and/or adminlte/adminlte/distribute this software for any
    ...
    */
    ...
    var BASE_OPTION_REFINERS = {
        ...
        eventDragMinadminlte/adminlte/distance: Number,
        expandRows: Boolean,
        height: identity,
        ...
        selectMinadminlte/adminlte/distance: Number,
        selectable: Boolean,
    ...
    var BASE_OPTION_DEFAULTS = {
        ...
        longPressDelay: 1000,
        eventDragMinadminlte/adminlte/distance: 5,
        expandRows: false,
        navLinks: false,
        selectable: false,
        eventMinHeight: 15,
    ...
    */
    ...
    function computeFallbackHeaderFormat(datesRepadminlte/adminlte/distinctDays, dayCnt) {
        // if more than one week row, or if there are a lot of columns with not much space,
        // put just the day numbers will be in each cell
        if (!datesRepadminlte/adminlte/distinctDays || dayCnt > 10) {
    ...
    var DayHeader = /** @class */ (function (_super) {
        ...
        DayHeader.prototype.render = function () {
            ...
            var _a = this.props, dates = _a.dates, dateProfile = _a.dateProfile, datesRepadminlte/adminlte/distinctDays = _a.datesRepadminlte/adminlte/distinctDays, renderIntro = _a.renderIntro;
            var dayHeaderFormat = this.createDayHeaderFormatter(context.options.dayHeaderFormat, datesRepadminlte/adminlte/distinctDays, dates.length);
            return (createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) { return (createElement("tr", { role: "row" },
                renderIntro && renderIntro('day'),
                dates.map(function (date) { return (datesRepadminlte/adminlte/distinctDays ? (createElement(TableDateCell, { key: date.toISOString(), date: date, dateProfile: dateProfile, todayRange: todayRange, colCnt: dates.length, dayHeaderFormat: dayHeaderFormat })) : (createElement(TableDowCell, { key: date.getUTCDay(), dow: date.getUTCDay(), dayHeaderFormat: dayHeaderFormat }))); }))); }));
        };
        return DayHeader;
    }(BaseComponent));
    function createDayHeaderFormatter(explicitFormat, datesRepadminlte/adminlte/distinctDays, dateCnt) {
        return explicitFormat || computeFallbackHeaderFormat(datesRepadminlte/adminlte/distinctDays, dateCnt);
    }
    ...
    */
    ...
    function renderMicroColGroup(cols, shrinkWidth) {
        ...
        HOWEVER, Chrome was getting messing up adminlte/adminlte/distributing the width to <td>/<th> elements with colspans.
    ...
    */
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.handleSide = function (edge, seconds) {
            ...
            var invadminlte/adminlte/distance = edgeThreshold - edge.adminlte/adminlte/distance;
            var velocity = // the closer to the edge, the faster we scroll
             ((invadminlte/adminlte/distance * invadminlte/adminlte/distance) / (edgeThreshold * edgeThreshold)) * // quadratic
        ...
        AutoScroller.prototype.computeBestEdge = function (left, top) {
            ...
            for (var _i = 0, _a = this.scrollCaches; _i < _a.length; _i++) {
                ...
                var leftadminlte/adminlte/dist = left - rect.left;
                var rightadminlte/adminlte/dist = rect.right - left;
                var topadminlte/adminlte/dist = top - rect.top;
                var bottomadminlte/adminlte/dist = rect.bottom - top;
                // completely within the rect?
                if (leftadminlte/adminlte/dist >= 0 && rightadminlte/adminlte/dist >= 0 && topadminlte/adminlte/dist >= 0 && bottomadminlte/adminlte/dist >= 0) {
                    if (topadminlte/adminlte/dist <= edgeThreshold && this.everMovedUp && scrollCache.canScrollUp() &&
                        (!bestSide || bestSide.adminlte/adminlte/distance > topadminlte/adminlte/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'top', adminlte/adminlte/distance: topadminlte/adminlte/dist };
                    }
                    if (bottomadminlte/adminlte/dist <= edgeThreshold && this.everMovedDown && scrollCache.canScrollDown() &&
                        (!bestSide || bestSide.adminlte/adminlte/distance > bottomadminlte/adminlte/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'bottom', adminlte/adminlte/distance: bottomadminlte/adminlte/dist };
                    }
                    if (leftadminlte/adminlte/dist <= edgeThreshold && this.everMovedLeft && scrollCache.canScrollLeft() &&
                        (!bestSide || bestSide.adminlte/adminlte/distance > leftadminlte/adminlte/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'left', adminlte/adminlte/distance: leftadminlte/adminlte/dist };
                    }
                    if (rightadminlte/adminlte/dist <= edgeThreshold && this.everMovedRight && scrollCache.canScrollRight() &&
                        (!bestSide || bestSide.adminlte/adminlte/distance > rightadminlte/adminlte/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'right', adminlte/adminlte/distance: rightadminlte/adminlte/dist };
                    }
                }
            }
            return bestSide;
    ...
    - minimum adminlte/adminlte/distance required before dragging
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.delay = null;
            _this.minadminlte/adminlte/distance = 0;
            _this.touchScrollAllowed = true; // prevents drag from starting and blocks scrolling during drag
            _this.mirrorNeedsRevert = false;
            _this.isInteracting = false; // is the user validly moving the pointer? lasts until pointerup
            _this.isDragging = false; // is it INTENTFULLY dragging? lasts until after revert animation
            _this.isDelayEnded = false;
            _this.isadminlte/adminlte/distanceSurpassed = false;
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    if (_this.isInteracting && // not destroyed via pointerdown handler
                        ...
                        _this.startDelay(ev);
                        if (!_this.minadminlte/adminlte/distance) {
                            _this.handleadminlte/adminlte/distanceSurpassed(ev);
                        }
                    }
                }
            };
            _this.onPointerMove = function (ev) {
                if (_this.isInteracting) {
                    ...
                    if (!_this.isadminlte/adminlte/distanceSurpassed) {
                        var minadminlte/adminlte/distance = _this.minadminlte/adminlte/distance;
                        var adminlte/adminlte/distanceSq = void 0; // current adminlte/adminlte/distance from the origin, squared
                        var deltaX = ev.deltaX, deltaY = ev.deltaY;
                        adminlte/adminlte/distanceSq = deltaX * deltaX + deltaY * deltaY;
                        if (adminlte/adminlte/distanceSq >= minadminlte/adminlte/distance * minadminlte/adminlte/distance) { // use pythagorean theorem
                            _this.handleadminlte/adminlte/distanceSurpassed(ev);
                        }
                    }
                    if (_this.isDragging) {
        ...
        FeaturefulElementDragging.prototype.handleadminlte/adminlte/distanceSurpassed = function (ev) {
            this.isadminlte/adminlte/distanceSurpassed = true;
            this.tryStartDrag(ev);
        };
        FeaturefulElementDragging.prototype.tryStartDrag = function (ev) {
            if (this.isDelayEnded && this.isadminlte/adminlte/distanceSurpassed) {
    ...
    */
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            dragging.minadminlte/adminlte/distance = options.selectMinadminlte/adminlte/distance || 0;
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                dragging.minadminlte/adminlte/distance = ev.isTouch ? 0 : options.eventDragMinadminlte/adminlte/distance;
                dragging.delay =
    ...
    var EventResizing = /** @class */ (function (_super) {
        ...
        function EventResizing(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                _this.dragging.minadminlte/adminlte/distance = component.context.options.eventDragMinadminlte/adminlte/distance;
    ...
    */
    var ExternalDraggable = /** @class */ (function () {
        function ExternalDraggable(el, settings) {
            ...
            this.handlePointerDown = function (ev) {
                var dragging = _this.dragging;
                var _a = _this.settings, minadminlte/adminlte/distance = _a.minadminlte/adminlte/distance, longPressDelay = _a.longPressDelay;
                dragging.minadminlte/adminlte/distance =
                    minadminlte/adminlte/distance != null ?
                        minadminlte/adminlte/distance :
                        (ev.isTouch ? 0 : BASE_OPTION_DEFAULTS.eventDragMinadminlte/adminlte/distance);
                dragging.delay =
    ...
    var InferredElementDragging = /** @class */ (function (_super) {
        ...
        function InferredElementDragging(containerEl) {
            ...
            _this.handlePointerDown = function (ev) {
                _this.emitter.trigger('pointerdown', ev);
                if (!_this.shouldIgnoreMove) {
                    // fire dragstart right away. does not support delay or min-adminlte/adminlte/distance
                    _this.emitter.trigger('dragstart', ev);
                }
            };
    ...
    */
    ...
    var DayTableView = /** @class */ (function (_super) {
        ...
        DayTableView.prototype.render = function () {
            ...
            var headerContent = options.dayHeaders && (createElement(DayHeader, { ref: this.headerRef, dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRepadminlte/adminlte/distinctDays: dayTableModel.rowCnt === 1 }));
    ...
    */
    ...
    var DayTimeColsView = /** @class */ (function (_super) {
        ...
        DayTimeColsView.prototype.render = function () {
            ...
            var headerContent = options.dayHeaders && (createElement(DayHeader, { dates: dayTableModel.headerDates, dateProfile: dateProfile, datesRepadminlte/adminlte/distinctDays: true, renderIntro: hasAttachedAxis ? this.renderHeadAxis : null }));
