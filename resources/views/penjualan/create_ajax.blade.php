                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $kode }}" type="text" name="penjualan_kode" id="penjualan_kode"
                                class="form-control" readonly>
                            <small id="error-penjualan_kode" class="error-text form-text text-danger"></small>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Transaksi</label>
                            <input value="{{ date('Y-m-d\TH:i') }}" type="datetime-local" name="penjualan_tanggal"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="add_barang_id" class="form-control">
                                        ...
                                        @foreach ($barang as $b)
                                            <option value="{{ $b->barang_id }}" data-nama="{{ $b->barang_nama }}"
                                                data-kode="{{ $b->barang_kode }}" data-harga="{{ $b->harga_jual }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Jumlah</label>
                                    <input type="number" id="add_jumlah" class="form-control" min="1"
                                        value="1">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <button type="button" id="btn-add-item"
                                        class="btn btn-success btn-block">Tambah</button>
                                </div>
                            </div>
                        </div>
                    </div>
